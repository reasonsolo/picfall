# Django settings for picfall project.
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(os.path.abspath(os.path.dirname(__file__)), 'test.db'),                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '^p6h!$7tplfuifedw9g$_64^n*&amp;rx$50&amp;9#5i6=ck*ov##btje'
...
ROOT_URLCONF = 'picfall.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'picfall.wsgi.application'
